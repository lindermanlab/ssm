...
<!-- #region colab_type="text" id="8OzC8q4bRFQv" -->
...
<!-- #region colab_type="text" id="Ty3EOi8bRFQ1" -->
## Simulate (somewhat realistic) data
<!-- #endregion -->

<!-- #region colab_type="text" id="QxDoYCRDRFQ2" -->
...
<!-- #region colab_type="text" id="t91lYSkPRFQ7" -->
...
<!-- #region colab_type="text" id="DDu2GnRGRFQ-" -->
...
<!-- #region colab_type="text" id="twuPg8wRRFRC" -->
## Plot simulated data
<!-- #endregion -->

<!-- #region colab_type="text" id="1-VkH7xSRFRC" -->
...
<!-- #region colab_type="text" id="-Y7R3y6TRFRF" -->
### Discrete states ($z$)
<!-- #endregion -->
...
<!-- #region colab_type="text" id="ufQwDDKTRFRI" -->
...
<!-- #region colab_type="text" id="wOO48DPARFRN" -->
...
<!-- #region colab_type="text" id="OZ_iLjiyRFRV" -->
## Fit model to data
<!-- #endregion -->

<!-- #region colab_type="text" id="g6QfY0j-RFRV" -->
...
<!-- #region colab_type="text" id="_I-JFqbHRFRZ" -->
...
<!-- #region colab_type="text" id="syHDAea_RFRc" -->
...
```python colab={} colab_type="code" id="Oi8-3NcxRFRf" outputId="98075512-a594-4bae-fcf3-550affe796a6"
...
<!-- #region colab_type="text" id="0CjkFH63RFRh" -->
## Plot results
<!-- #endregion -->

<!-- #region colab_type="text" id="HDlMQx4ZRFRh" -->
### Discrete states ($z$)
<!-- #endregion -->
...
```python colab={} colab_type="code" id="HRPr3DJlRFRj" outputId="1d6b402b-fa6d-4040-f4bf-4e4c2188c8b8"
print('Discrete state accuracy: ', np.mean(zs==z_inferred2))
```

<!-- #region colab_type="text" id="SX1go1AyRFRl" -->
#### Shorter time window
<!-- #endregion -->
...
<!-- #region colab_type="text" id="e4Cz1o8GRFRo" -->
### Dynamics matrices ($A^z$)
<!-- #endregion -->
...
<!-- #region colab_type="text" id="b14UYWuMRFRr" -->
### Transitions
The contribution of population $j$ to staying in a state is $S_j x^{j}$ and the contribution to switching to a state is $R_j x^{j}$
...
<!-- #region colab_type="text" id="yz4GSxjrRFRt" -->
