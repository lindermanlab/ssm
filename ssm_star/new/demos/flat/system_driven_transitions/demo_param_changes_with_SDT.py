...
y, x_true, z_true = generate_multi_dim_data_with_multi_dim_states_and_two_regimes(
    N, D_true
)
...
slds = ssm_star.SLDS(
    N, K_true, D_true, L=L_true, emissions="gaussian", transitions="system_driven"
)
...
if smart_initialize:
    slds.initialize(
        y, num_init_restarts=num_init_ar_hmms, system_inputs=SYSTEM_REGIMES_ONE_HOT
    )
