...
true_slds = ssm_star.SLDS(N, K, D, emissions="bernoulli_orthog")
for k in range(K):
...
slds = ssm_star.SLDS(N, K, D, emissions="bernoulli_orthog")
slds.initialize(y)
...
print("Fitting SLDS with SVI using structured variational posterior")
slds = ssm_star.SLDS(N, K, D, emissions="bernoulli")
slds.initialize(y)
