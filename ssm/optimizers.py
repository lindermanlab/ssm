...
def _generic_minimize(method, loss, x0, verbose=False, num_iters=1000, state=None, full_output=False, warn_output=True, **kwargs):
    """
    ...
    if warn_output and not result.success:
